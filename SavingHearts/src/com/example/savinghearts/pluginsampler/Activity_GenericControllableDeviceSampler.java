...
public class Activity_GenericControllableDeviceSampler extends Activity
{
    ...
    private void resetPcc()
    {
        ...
        AntPlusGenericControllableDevicePcc.requestAccess(this, new IPluginAccessResultReceiver<AntPlusGenericControllableDevicePcc>()
            {
            @Override
            public void onResultReceived(AntPlusGenericControllableDevicePcc result, RequestAccessResult requestAccessResult, DeviceState initialDeviceState)
            {
                switch(requestAccessResult)
                {
                    ...
                    case UNRECOGNIZED:
                        ...
                        Toast.makeText(Activity_GenericControllableDeviceSampler.this, "Failed: UNRECOGNIZED. Upgrade Required?", Toast.LENGTH_SHORT).show();
                        tv_status.setText("Error. Do Menu->Reset.");
                        break;
                    default:
