...
public class Activity_AudioControllableDeviceSampler extends Activity
{
    ...
    private void resetPcc()
    {
        ...
        AntPlusAudioControllableDevicePcc.requestAccess(this, new IPluginAccessResultReceiver<AntPlusAudioControllableDevicePcc>()
            {
            @Override
            public void onResultReceived(AntPlusAudioControllableDevicePcc result, RequestAccessResult requestAccessResult, DeviceState initialDeviceState)
            {
                switch(requestAccessResult)
                {
                    ...
                    case UNRECOGNIZED:
                        ...
                        Toast.makeText(Activity_AudioControllableDeviceSampler.this, "Failed: UNRECOGNIZED. Upgrade Required?", Toast.LENGTH_SHORT).show();
                        tv_status.setText("Error. Do Menu->Reset.");
                        break;
                    default:
