...
public class Activity_VideoControllableDeviceSampler extends Activity
{
    ...
    private void resetPcc()
    {
        ...
        AntPlusVideoControllableDevicePcc.requestAccess(this, new IPluginAccessResultReceiver<AntPlusVideoControllableDevicePcc>()
            {
            @Override
            public void onResultReceived(AntPlusVideoControllableDevicePcc result, RequestAccessResult requestAccessResult, DeviceState initialDeviceState)
            {
                switch(requestAccessResult)
                {
                    ...
                    case UNRECOGNIZED:
                        ...
                        Toast.makeText(Activity_VideoControllableDeviceSampler.this, "Failed: UNRECOGNIZED. Upgrade Required?", Toast.LENGTH_SHORT).show();
                        tv_status.setText("Error. Do Menu->Reset.");
                        break;
                    default:
