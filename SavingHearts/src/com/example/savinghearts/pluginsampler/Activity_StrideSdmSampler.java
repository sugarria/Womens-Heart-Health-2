        ...
        AntPlusStrideSdmPcc.requestAccess(this, this,
                ...
                RequestAccessResult resultCode, DeviceState initialDeviceState)
            {
                switch(resultCode)
                {
                    ...
                    case UNRECOGNIZED:
                        ...
                        Toast.makeText(Activity_StrideSdmSampler.this, "Failed: UNRECOGNIZED. Upgrade Required?", Toast.LENGTH_SHORT).show();
                        tv_status.setText("Error. Do Menu->Reset.");
                        break;
                    default:
            ...
            private void subscribeToEvents()
            {
                ...
                sdmPcc.subscribeDataLatencyEvent(
                    ...
                    {
                        @Override
                        public void onNewDataLatency(final long estTimestamp, final EnumSet<EventFlag> eventFlags, final BigDecimal updateLatency)
                        {
                            runOnUiThread(
                                new Runnable()
                                {                                            
