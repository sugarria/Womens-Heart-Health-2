...
public class Activity_BikeSpeedDistanceSampler extends Activity
{
    ...
    private void resetPcc()
    {
        ...
        AntPlusBikeSpeedDistancePcc.requestAccess(this, this, 
                ...
                RequestAccessResult resultCode, DeviceState initialDeviceState)
            {
                switch(resultCode)
                {
                    ...
                    case CHANNEL_NOT_AVAILABLE:
                        Toast.makeText(Activity_BikeSpeedDistanceSampler.this, "Channel Not Available", Toast.LENGTH_SHORT).show();
                        tv_status.setText("Error. Do Menu->Reset.");
                        break;
                    case OTHER_FAILURE:
                        Toast.makeText(Activity_BikeSpeedDistanceSampler.this, "RequestAccess failed. See logcat for details.", Toast.LENGTH_SHORT).show();
                        tv_status.setText("Error. Do Menu->Reset.");
                        break;
                    case DEPENDENCY_NOT_INSTALLED:
                        tv_status.setText("Error. Do Menu->Reset.");
                        AlertDialog.Builder adlgBldr = new AlertDialog.Builder(Activity_BikeSpeedDistanceSampler.this);
                    ...
                    case UNRECOGNIZED:
                        ...
                        Toast.makeText(Activity_BikeSpeedDistanceSampler.this, "Failed: UNRECOGNIZED. Upgrade Required?", Toast.LENGTH_SHORT).show();
                        tv_status.setText("Error. Do Menu->Reset.");
                        break;
                    default:
                        Toast.makeText(Activity_BikeSpeedDistanceSampler.this, "Unrecognized result: " + resultCode, Toast.LENGTH_SHORT).show();
                        tv_status.setText("Error. Do Menu->Reset.");
                        break;
                } 
            }
            ...
            {
                bsdPcc.subscribeCalculatedSpeedEvent(new CalculatedSpeedReceiver(new BigDecimal(2.095)) //2.095m circumference = an average 700cx23mm road tire
                {                                    
                    @Override
                ...
                bsdPcc.subscribeCalculatedAccumulatedDistanceEvent(new CalculatedAccumulatedDistanceReceiver(new BigDecimal(2.095)) //2.095m circumference = an average 700cx23mm road tire
                {

                    @Override
                    public void onNewCalculatedAccumulatedDistance(final long estTimestamp, final EnumSet<EventFlag> eventFlags,
                        final BigDecimal calculatedAccumulatedDistance)
                    {
                        ...
                        {                                            
                            ...
                            public void run()
                            {
                                ...
                                tv_calculatedAccumulatedDistance.setText(String.valueOf(calculatedAccumulatedDistance.setScale(3, RoundingMode.HALF_UP)));
                            }
                        });
                    }
                });
                ...
                {                                    
                    @Override
                    public void onNewRawSpeedAndDistanceData(final long estTimestamp, final EnumSet<EventFlag> eventFlags,
                ...
                if(bsdPcc.isSpeedAndCadenceCombinedSensor())
                {
                    ...
                    AntPlusBikeCadencePcc.requestAccess(Activity_BikeSpeedDistanceSampler.this, bsdPcc.getAntDeviceNumber(), 0, true, 
                                        ...
                                        DeviceState initialDeviceStateCode)
                                {
                                    switch(resultCode)
                                    {
                                        case SUCCESS:
                                            ...
                                            break;
                                        case CHANNEL_NOT_AVAILABLE:
                                            tv_calculatedCadence.setText("CHANNEL NOT AVAILABLE");
                                            break;
                                        case OTHER_FAILURE:
                                            tv_calculatedCadence.setText("OTHER FAILURE");
                                            break;
                                        case DEPENDENCY_NOT_INSTALLED:
                                            tv_calculatedCadence.setText("DEPENDENCY NOT INSTALLED");
                                            break;
                                        default:
                                            tv_calculatedCadence.setText("UNRECOGNIZED ERROR: " + resultCode);
                                            break;
                                    } 
                                }
                            },
